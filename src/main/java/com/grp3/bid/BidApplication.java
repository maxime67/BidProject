...
public class BidApplication {
    ...
    public void init() {
        ...
        productService.insertProduct(new Product("nameProd","aaaa",1L,"aaa",  LocalDateTime.now(), LocalDateTime.now().plusMonths(1), userService.getUserByid(1), cat1));
        productService.insertProduct(new Product("nameProd","aaaa",1L,"aaa",  LocalDateTime.now(), LocalDateTime.now().plusMonths(1), userService.getUserByid(1),cat2));
