...
public class OfferDAOImpl implements OfferDAO {
    ...
    private final String insertOffer = "INSERT INTO OFFER (value_offer,date_offer,id_product,id_user_app) VALUES (:value_offer,:date_offer,:id_product,:id_user_app);";
    private final String updateOffer = "UPDATE OFFER SET value=?,offer_datetime=?,id_user=?,id_product=? WHERE id_offer = ?;";

    public OfferDAOImpl(NamedParameterJdbcTemplate jdbcTemplate, ProductDAO productDAO, UserDAO userDAO) {
    ...
    public boolean insertOffer(Offer offer) {
        ...
        sqlParameterSource.addValue("date_offer", offer.getOfferDateTime());
